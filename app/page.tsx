  ...
  return (
    <div className="w-full bg-transparent">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            <div className="animate-fade-in">
              <Badge className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-gray-900 border border-purple-500/30 backdrop-blur-sm px-6 py-3 text-sm">
            ...
            {/* Main Heading */}
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-gray-900 mb-6 animate-fade-in-up leading-tight">
              Welcome to the
              <br />
            ...
            {/* Subtitle */}
            <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto animate-fade-in-up animation-delay-200 leading-relaxed">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-8 animate-fade-in-up animation-delay-600">
              {['AI-Powered', 'Real-Time Processing', 'Secure & Scalable'].map((feature, index) => (
                <div
                  key={index}
                  className="px-6 py-3 rounded-full bg-purple-100 backdrop-blur-md border border-purple-300 text-gray-900 text-sm font-medium hover:bg-purple-200 transition-all duration-300 cursor-default"
                >
                  {feature}
                </div>
              ))}
      ...
      <section 
        ...
        className={`relative py-32 px-4 sm:px-6 lg:px-8 bg-gray-50 transition-all duration-1000 ${
          visibleSections.has(0) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
        }`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <Badge className="bg-purple-100 text-purple-700 border border-purple-300 mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card 
                key={index}
                className="bg-white border-gray-200 hover:border-purple-300 transition-all duration-300 hover:scale-105 hover:shadow-2xl"
              >
      ...
      <section 
        ...
        className={`relative py-32 px-4 sm:px-6 lg:px-8 bg-white transition-all duration-1000 ${
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {[
              ...
              <div 
                key={index}
                className="group relative p-8 rounded-2xl bg-gray-50 border border-gray-200 hover:border-purple-300 transition-all duration-300"
              >
      ...
      <section 
        ...
        className={`relative py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 transition-all duration-1000 ${
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <Badge className="bg-green-100 text-green-700 border border-green-300 mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="relative">
                <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-purple-300 transition-all duration-300 h-full hover:shadow-xl">
